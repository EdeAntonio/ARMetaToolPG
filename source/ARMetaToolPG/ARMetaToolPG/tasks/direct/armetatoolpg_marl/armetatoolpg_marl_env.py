...
from .armetatoolpg_marl_env_cfg import ArmetatoolpgMarlEnvCfg


class ArmetatoolpgMarlEnv(DirectMARLEnv):
    cfg: ArmetatoolpgMarlEnvCfg

    def __init__(self, cfg: ArmetatoolpgMarlEnvCfg, render_mode: str | None = None, **kwargs):
