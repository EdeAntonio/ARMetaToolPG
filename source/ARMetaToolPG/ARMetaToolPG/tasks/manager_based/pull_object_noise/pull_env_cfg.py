...
class PullObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    object = RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(pos=[0.6, -0.4, 0.055], rot=[0, 0, 0, 1]), #pos and rot needs to be accesible for tool generation process
        spawn=UsdFileCfg(
...
class CommandsCfg:
    ...
    object_pose = mdp.UniformPoseCommandCfg(
        ...
        debug_vis=True,
        ranges=mdp.UniformPoseCommandCfg.Ranges(
            pos_x=(0.4, 0.4), pos_y=(-0.3, -0.3), pos_z=(0.0, 0.0), roll=(0.0, 0.0), pitch=(0.0, 0.0), yaw=(0.0, 0.0)
        ),
    )
...
#        }
#    )
    scale_object_random_mass = EventTerm(
    ...
    scale_tool_random_mass = EventTerm(
        func=events.randomize_rigid_body_mass,
        mode="reset",
        params={
            "asset_cfg" : SceneEntityCfg(name="tool"),
...
class RewardsCfg:
    ...
    reaching_tool = RewTerm(func=mdp.tool_ee_distance, params={"std": 0.15}, weight=1)
    ...
    #grasping_tool = RewTerm(func=mdp.tool_is_grasped, params={"std": 0.1}, weight=8.0) # FOR ROBOHABILIS
    ...
    #TODO: Add a penalty if the arm collides with the table
